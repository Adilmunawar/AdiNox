  ...
  return (
    <div className="w-full space-y-6">
      <div className="relative">
        <div
          className="relative bg-card border border-border rounded-2xl p-6 sm:p-8 overflow-hidden"
          style={{ boxShadow: '0 4px 24px -4px rgba(0,0,0,0.06), 0 0 0 1px rgba(20, 184, 166, 0.04)' }}
        >
          {/* Top accent line */}
          ...
          >
            ...
            <p className="text-muted-foreground text-[11px] tracking-[0.15em] uppercase font-medium mt-1.5">
          ...
          <Tabs value={activeTab} onValueChange={onTabChange} className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-6 h-11 p-1 bg-muted rounded-xl border border-border">
              <TabsTrigger
                value="login"
                className="h-9 text-xs font-semibold data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:shadow-primary/15 rounded-lg transition-all duration-200 data-[state=inactive]:text-muted-foreground hover:text-foreground"
              >
      ...
      <motion.p
        className="text-center text-[10px] text-muted-foreground/50 tracking-wider lg:hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
